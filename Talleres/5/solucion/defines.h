...
#define GDT_CODE_0_SEL (GDT_IDX_CODE_0 << 3) | b000
#define GDT_DATA_0_SEL (GDT_IDX_DATA_0 << 3) | b000
#define GDT_CODE_3_SEL (GDT_IDX_CODE_3 << 3) | b011
#define GDT_DATA_3_SEL (GDT_IDX_DATA_3 << 3) | b011
